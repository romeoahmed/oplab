...
/// Maximum JSON control-frame size, checked before allocation.
pub const MAX_CONTROL_BYTES: usize = 1024 * 1024;
/// Maximum binary-frame size, including operation-specific metadata.
pub const MAX_BINARY_BYTES: usize = 64 * 1024;

/// Frame bodies are never interpreted by guessing from their contents.
