...
/// Protocol compatibility is negotiated before accepting work.
pub const VERSION: u32 = 1;
/// Bound input independently of preprocessing expansion and emitted bytes.
pub const MAX_SOURCE_BYTES: usize = 256 * 1024;
/// Bound allocated section contents independently of ELF file overhead.
...
/// Bound each complete object/image file and its binary transfer.
...
/// Requests share correlation but do not acquire implicit retry semantics.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize, TS)]
#[serde(deny_unknown_fields)]
pub struct Request {
...
pub enum Command {
    ...
    /// Finish the connection after responding to this request.
    Shutdown,
}
...
pub enum Reply {
    ...
    /// The worker accepted an orderly shutdown.
    Closed,
