...
/// Build with cooperative cancellation between native stages.
///
/// Active LLVM/LLD calls run to completion. The scheduler must also check cancellation
/// before publishing a result.
///
/// # Errors
///
/// Returns validation, compilation, linking or cooperative cancellation diagnostics.
...
/// # Errors
///
/// Rejects stale backend identity, invalid addresses and empty or oversized source.
pub fn validate_build(build: &BuildIdentity, source: &str) -> Result<(), Diagnostic> {
