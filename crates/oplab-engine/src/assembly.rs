...
/// Immutable build outputs. ELF owns section, symbol, relocation, and segment semantics.
#[derive(Debug)]
pub struct BuildArtifact {
    /// The complete source and link settings this result belongs to.
    pub identity: BuildIdentity,
    /// Original relocatable ELF, before final address assignment.
    pub object: Vec<u8>,
    /// Final executable ELF, including file-backed and zero-filled load regions.
    pub image: Vec<u8>,
}

/// Exact MC release used by this process.
#[must_use]
...
///
/// # Errors
/// Rejects empty/oversized source, MC errors, and invalid or oversized object output.
...
/// Link a validated object at the requested `.text` address, without changing it.
/// The object can be linked repeatedly; loading into a machine is a separate operation.
///
/// # Errors
/// Rejects conflicting alignment, undefined symbols, failed relocations, address
/// overflow, and output limits. Raw native diagnostics and scratch paths stay private.
pub fn link(
